...
16. `docs/consciousness-core/NOVA_SOVEREIGN_N1_N12_MACRO_HIERARCHY_CANON.md`
...
Enterprise library index:
- `docs/INDEX.md`

AI workforce operating library:
- `docs/internal-ai-teams/README_INTERNAL_AI_TEAMS.md`

External projection library:
- `docs/external-products/README_EXTERNAL_PRODUCTS.md`

Model directory system:
