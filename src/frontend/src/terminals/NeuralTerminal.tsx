...
import { useCanisterWire, extractNeuralLogs } from './useCanisterWire';
...
export function NeuralTerminal() {
  ...
  const wire = useCanisterWire('NEURAL', 3000, extractNeuralLogs);
  const packages = getPackagesByDomain('NEURAL');
  const calls = getCallsByDomain('NEURAL');
