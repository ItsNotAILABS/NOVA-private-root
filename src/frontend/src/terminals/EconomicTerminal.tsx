...
import { useCanisterWire, extractEconomicLogs } from './useCanisterWire';
...
export function EconomicTerminal() {
  ...
  const wire = useCanisterWire('ECONOMIC', 3000, extractEconomicLogs);
  const packages = getPackagesByDomain('ECONOMIC');
  const calls = getCallsByDomain('ECONOMIC');
