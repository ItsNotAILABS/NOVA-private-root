...
import { useCanisterWire, extractSwarmLogs } from './useCanisterWire';
...
export function SwarmTerminal() {
  ...
  const wire = useCanisterWire('SWARM', 3000, extractSwarmLogs);
  const packages = getPackagesByDomain('SWARM');
  const calls = getCallsByDomain('SWARM');
