...
const base = path.join(root, 'products/signallens-edge');
const required = [
  'package.json',
  'src/index.js',
  'src/adapters.js',
...
const banned = [/guaranteed access to every platform/i, /bypass login/i, /evade rate limits/i, /scrape private data/i];
